...
export function RichNoteEditor({ content, onContentChange, autoFocus }) {
    ...
    return (_jsx("div", { className: "rounded-xl bg-slate-800/50 border border-slate-700 p-3 flex-grow overflow-y-auto", children: _jsx(EditorContent, { editor: editor }) }));
}
