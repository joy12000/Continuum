...
export default function MoonSettingsButton(props) {
    return (_jsx("button", { "aria-label": "\uC124\uC815 \uC5F4\uAE30", ...props, className: "rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-sky-300/70 " + (props.className || ""), style: {
            ...(props.style || {}),
