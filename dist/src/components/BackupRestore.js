 ...
 */
async function calculateNotesHash(notes) {
...
export function BackupRestore({ onNotesImported }) {
    /**
    ...
    return (_jsxs("div", { className: "card flex gap-2", children: [_jsx("button", { className: "btn", onClick: backup, children: "\uC554\uD638\uD654 \uBC31\uC5C5" }), _jsx("button", { className: "btn", onClick: restore, children: "\uBCF5\uC6D0" })] }));
}
