...
export default function HomeSky({ answerSignal, onOpenAnswer }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: "relative h-dvh w-full overflow-hidden text-white", children: [_jsx(Toasts, {}), _jsx(SkyCanvasAnimation, {}), _jsx("div", { className: "pointer-events-none absolute inset-0 z-10", style: {
                    ...
                    mixBlendMode: "screen",
                } }), !draft && (_jsx("div", { className: "pointer-events-none absolute inset-0 z-0 flex items-center justify-center px-6 md:px-12 text-center", style: { fontSize: "clamp(18px, 3.4vw, 28px)", lineHeight: 1.6, color: "rgba(220,235,255,0.42)", textShadow: "0 0 0.7rem rgba(150,190,255,0.2)" }, children: "\uBC24\uD558\uB298\uC5D0 \uC624\uB298\uC758 \uC870\uAC01\uC744 \uC0C8\uACA8\uBCF4\uC138\uC694." }))] }));
}
